...
<body leftmargin="0" topmargin="0" marginheight="0" marginwidth="0">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="cursor: hand" align="left" width="85">
                        <input class="statusBarOnlineNum" readonly size="3" name="user_count1" id="Text1"
                            runat="server">
                    </td>
                    ...
                    <td class="statusBarCenterText" title="点击这里刷新主操作区" nowrap align="center" width="200">
                    </td>
                    <td valign="middle" align="center" width="91">
                        <a style="color: #d50000" href="" target="table_main"><b></b></a>
                    </td>
                    <td align="right" width="25">
                        <a href="javascript:history.back()">
                            <img height="16" alt="后退" src="../images/status_bar_icon/arrow_back.gif" width="16"
                                border="0"></a>
                    </td>
                    <td align="right" width="25">
                        <a href="javascript:history.forward()">
                            <img height="16" alt="前进" src="../images/status_bar_icon/arrow_forward.gif" width="16"
                                border="0"></a>
                    </td>
                    <td nowrap align="right" width="25">
                        <a href="" target="_blank">
                            <img height="16" alt="使用帮助" src="../images/status_bar_icon/help.gif" width="16" border="0"></a>
                    </td>
                    <td nowrap align="right" width="25">
                        <a title="显示软件版权信息" href="" target="table_main">
                            <img height="16" alt="版权信息" src="../images/status_bar_icon/i_about.gif" width="16"
                                border="0"></a>
                    </td>
                    <td width="6">
                        &nbsp;
    ...
    <iframe name="ref_new_letter" src="" width="0" height="0"></iframe>
