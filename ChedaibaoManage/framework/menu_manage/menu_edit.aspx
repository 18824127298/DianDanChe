...
<script type="text/javascript">
    function ShowWindow() {
        ...
        window.open("uploadMenuIcon.aspx", "弹出窗口", "width=" + iWidth + ", height=" + iHeight + ",top=" + iTop + ",left=" + iLeft + ",toolbar=no, menubar=no, scrollbars=no, resizable=no,location=no, status=no,alwaysRaised=yes,depended=yes");

        //var ret= window.showModalDialog("uploadMenuIcon.aspx","","dialogWidth=310px;dialogHeight=240px");
        //if(ret!=null)
        //{
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td nowrap>
                                子系统：</td>
                            <td colspan="3">
                                &nbsp;<asp:DropDownList ID="ddlbSubSystem" runat="server" Width="300px"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td nowrap>
                                菜单选项：
