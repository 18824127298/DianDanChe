    ...
    <script type="text/javascript">
        function ImageChoice(img) {
            if (window.opener != null) {
                var nLastIndex = img.lastIndexOf('/');
                var imgMenuIcon = img.substring(nLastIndex + 1);
                window.opener.document.getElementById("hfImg").value = imgMenuIcon;
                window.opener.document.getElementById("edtMenuIcon").value = imgMenuIcon;
                window.opener.document.getElementById("imgMenuIcon").src = img;
            }
