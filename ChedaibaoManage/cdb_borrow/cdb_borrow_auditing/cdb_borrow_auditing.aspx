<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cdb_borrow_auditing.aspx.cs" Inherits="cdb_borrow_cdb_borrow_auditing_cdb_borrow_auditing" %>
                    ...
                    <asp:GridView ID="gvList" runat="server" CellSpacing="0" CellPadding="6" Width="100%" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" OnSorting="gvList_Sorting" EnableViewState="False">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="审核">
                                <ItemStyle HorizontalAlign="Center" />
                                <ItemTemplate>
                                    <%# VIVaduit(Eval("IsAudit"),Convert.ToInt32(Eval("lId")), Eval("Auditor").ToString()) %>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
