...
function Editor(content,path,width,height)
{
    //将参数path送给根路径RootPath
    RootPath=path;
    
   	document.write('<iframe name="wrEditor" id="wrEditor" width="'+width+'" height="'+height+'" src="about:blank"></iframe>');
...
<div id="html" style="display:none;"><textarea id="content" name="content" style="width:700px; height:280px;" runat="server"></textarea></div>
<div id="edit">
...
<tr>
	...
	<tr>
		...
		<td onclick="url()" class="Hand_Off"; onmouseover="this.className='Hand_On';" onmouseout="this.className='Hand_Off';"><img src="<%=this.JSRootPath %>Editor/images/wlink.gif" width="16" height="16" border="0" alt="超级链接"></td>
		<td onclick="unurl()" class="Hand_Off"; onmouseover="this.className='Hand_On';" onmouseout="this.className='Hand_Off';"><img src="<%=this.JSRootPath %>Editor/images/unlink.gif" width="16" height="16" border="0" alt="取消链接"></td>
		<td onclick="image('<%=Server.UrlEncode(this.ImgSavePath) %>')" class ="Hand_Off"; onmouseover="this.className='Hand_On';" onmouseout="this.className='Hand_Off';" style="width: 19px"><img src="<%=this.JSRootPath %>Editor/images/img.gif" width="16" height="16" border="0" alt="插入图片"></td>
		<td onclick="file('<%=Server.UrlEncode(this.FileSavePath) %>')" class ="Hand_Off"; onmouseover="this.className='Hand_On';" onmouseout="this.className='Hand_Off';" style="width: 19px"><img src="<%=this.JSRootPath %>Editor/images/report_word.png" width="16" height="16" border="0" alt="上传附件"></td>
		<td onclick="flash()" class="Hand_Off"; onmouseover="this.className='Hand_On';" onmouseout="this.className='Hand_Off';"><img src="<%=this.JSRootPath %>Editor/images/swf.gif" width="16" height="16" border="0" alt="插入Flash动画"></td>
		<td onclick="wmv()" class="Hand_Off"; onmouseover="this.className='Hand_On';" onmouseout="this.className='Hand_Off';"><img src="<%=this.JSRootPath %>Editor/images/wmv.gif" width="16" height="16" border="0" alt="插入Windows Media"></td>
		<td onclick="rm()" class="Hand_Off"; onmouseover="this.className='Hand_On';" onmouseout="this.className='Hand_Off';"><img src="<%=this.JSRootPath %>Editor/images/rm.gif" width="16" height="16" border="0" alt="插入RM电影"></td>		
...
<script language="javascript" type="text/javascript">
<!--
	Editor(document.<%=this.Page.Form.ID %>.<%=this.content.ClientID %>.value,"<%=this.JSRootPath %>","<%=this.Width %>","<%=this.Height %>");
//-->
</script>
	</td>
</tr>
