    ...
    public class JsApiPay
    {
	    ...
	    */
        ...
        public WxPayData GetUnifiedOrderResult()
        {
            ...
            WxPayData result = JiaYouWxPayApi.UnifiedOrder(data);
        ...
        */
        public string GetJsApiParameters()
        {
            ...
            jsApiParam.SetValue("timeStamp", JiaYouWxPayApi.GenerateTimeStamp());
            jsApiParam.SetValue("nonceStr", JiaYouWxPayApi.GenerateNonceStr());
            jsApiParam.SetValue("package", "prepay_id=" + unifiedOrderResult.GetValue("prepay_id"));
            jsApiParam.SetValue("signType", "MD5");
            jsApiParam.SetValue("paySign", jsApiParam.MakeSign("MD5").ToUpper());
	    ...
	    */
        public string GetEditAddressParameters()
	    {
            ...
            try
            {
                ...
                signData.SetValue("timestamp", JiaYouWxPayApi.GenerateTimeStamp());
                signData.SetValue("noncestr", JiaYouWxPayApi.GenerateNonceStr());
