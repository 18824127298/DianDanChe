    ...
    public class MicroPay
    {
        ...
        */
        public static string Run(string body, string total_fee, string auth_code)
        {
            ...
            data.SetValue("out_trade_no", JiaYouWxPayApi.GenerateOutTradeNo());//产生随机的商户订单号

            WxPayData result = JiaYouWxPayApi.Micropay(data, 10); //提交被扫支付，接收返回结果
	    ...
	    */
        public static WxPayData Query(string out_trade_no, out int succCode)
	    {
            ...
            WxPayData result = JiaYouWxPayApi.OrderQuery(queryOrderInput);
	    ...
	    */
	    public static bool Cancel(string out_trade_no, int depth = 0)
	    {
            ...
            WxPayData result = JiaYouWxPayApi.Reverse(reverseInput);
