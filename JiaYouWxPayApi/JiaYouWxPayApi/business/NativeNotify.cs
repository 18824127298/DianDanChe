...
namespace JiaYouWxPayApi
{
    ...
    public class NativeNotify:Notify
    {
        ...
        public override void ProcessNotify()
        {
            ...
            data.SetValue("nonce_str", JiaYouWxPayApi.GenerateNonceStr());
        ...
        private WxPayData UnifiedOrder(string openId,string productId)
        {
            ...
            req.SetValue("out_trade_no", JiaYouWxPayApi.GenerateOutTradeNo());
            ...
            WxPayData result = JiaYouWxPayApi.UnifiedOrder(req);
            return result;
        }
    }
}