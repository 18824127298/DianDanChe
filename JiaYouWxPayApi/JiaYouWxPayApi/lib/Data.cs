    ...
    public class WxPayData
    {
        ...
        */
        public SortedDictionary<string, object> FromXml(string xml)
        {
            ...
            try
            {
                ...
                {
                    //支付不成功
                    throw new WxPayException("支付不成功");
                }
            }
        ...
        */
        public bool CheckSign(string signType)
        {
            ...
            if (!IsSet("sign"))
            {
                DebugLogger.LogDebugMessage(this.GetType().ToString() + "WxPayData签名不存在!");
                throw new WxPayException("WxPayData签名存在但不合法!");
            }
            //如果设置了签名但是签名为空，则抛异常
            else if (GetValue("sign") == null || GetValue("sign").ToString() == "")
            {
                DebugLogger.LogDebugMessage(this.GetType().ToString() + "WxPayData签名存在但不合法!");
                throw new WxPayException("WxPayData签名存在但不合法!");
            }
            ...
            DebugLogger.LogDebugMessage(this.GetType().ToString() + "WxPayData签名验证错误!");
            throw new WxPayException("WxPayData签名验证错误! return_sign" + GetValue("sign").ToString() + ";cal_sign" + MakeSign(signType));
        }
