            ...
            try
            {
                ...
                * ************************************************************/
                ...
                if (isUseCert)
                {
                    ...
                    X509Certificate2 cert = new X509Certificate2(WxPayConfig.GetConfig().GetSSlCertPath(), WxPayConfig.GetConfig().GetSSlCertPassword(), X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.Exportable); 
                    request.ClientCertificates.Add(cert);
                    DebugLogger.LogDebugMessage("WxPayApi" + " PostXml used cert");
                }
