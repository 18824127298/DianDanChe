<%@ Page Language="C#" AutoEventWireup="true" CodeFile="salesman_statistics_list.aspx.cs" Inherits="borrower_borrow_list_salesman_statistics_list" %>
...
<script type="text/javascript">
    ...
    $(function () {
        $.ajax({
            type: 'get',
            async: false,
            url: 'salesman_statistics_list.aspx?r=' + Math.random(),
            data: {
                Action: 'SalesmanStatisticsList'
            },
            success: function (data) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    html += "<tr>";
                    html += "    <td style='color:#ff0000'>" + json[i].FullName + "</td>";
                    if (json[i].March > 0)
