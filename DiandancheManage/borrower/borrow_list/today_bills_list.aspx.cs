...
public partial class borrower_borrow_list_today_bills_list : SbtPageBase
{
    ...
    private void FetchDataFromDB()
    {
        ...
        gvList.DataBind();
        PageParameter.SetCustomParamObject("today_bills_list", ds);
    ...
    {
        DataSet ds = PageParameter.GetCustomParamObject("today_bills_list") as DataSet;

        string sTemplateFile = MapPath("../excel_template/当天未还款.xls");
        ...
        string sFileName = "当天未还款" + DateTime.Now.ToString("yyyyMMddHHmms") + ".xls";
