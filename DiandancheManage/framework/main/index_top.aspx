<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index_top.aspx.cs" Inherits="farmwork_main_index_top" %>
    ...
    <script language="JavaScript">
        ...
        function iflogout() {
            if (window.confirm('确定注销吗？')) {
                ...
                parent.parent.location = "../admin/homepage.aspx?log_out=Y";        // 页面跳转
            }
        }
        ...
        function ifhomepage() {
            parent.parent.location = "../admin/homepage.aspx";
        }
