<%@ Page Language="C#" AutoEventWireup="true" CodeFile="card_insert.aspx.cs" Inherits="import_execl_import_card_insert" %>
        ...
        <div>
                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="lblTitle" runat="server" Text="卡号的导入"></asp:Label>
                        </td>
                    </tr>
                </table>
                <hr />
            ...
            <div class="contentTable">
                ...
                <table border="0" width="450" cellpadding="8" cellspacing="1" align="center">
                    <thead>
                        <tr>
                            <td colspan="2" align="center">卡号的导入
                            </td>
                        </tr>
                    </thead>
                    <tbody>
