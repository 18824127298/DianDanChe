<%@ Page Language="C#" AutoEventWireup="true" CodeFile="borrow_import.aspx.cs" Inherits="import_execl_import_borrow_import" %>
        ...
        <div>
                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="lblTitle" runat="server" Text="账单的导入"></asp:Label>
                        </td>
                    </tr>
                </table>
                <hr />
            ...
            <div class="contentTable">
                ...
                <table border="0" width="450" cellpadding="8" cellspacing="1" align="center">
                    <thead>
                        <tr>
                            <td colspan="2" align="center">账单的导入
                            </td>
                        </tr>
                    </thead>
                    <tbody>
