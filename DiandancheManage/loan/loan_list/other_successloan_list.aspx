<%@ Page Language="C#" AutoEventWireup="true" CodeFile="other_successloan_list.aspx.cs" Inherits="loan_loan_list_other_successloan_list" %>
                    ...
                    <td>
                        <asp:GridView ID="gvList" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" OnSorting="gvList_Sorting" EnableViewState="False" CellPadding="8">
                            <Columns>
                                ...
                                <asp:BoundField DataField="TotalAmountStage" HeaderText="车辆总价格" SortExpression="TotalAmountStage">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="Deposit" HeaderText="押金" SortExpression="Deposit">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CustomerClassification" HeaderText="客户的类型" SortExpression="CustomerClassification">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                 <asp:BoundField DataField="MerchantAuditor" HeaderText="商户审核人" SortExpression="MerchantAuditor">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SecondAuditor" HeaderText="终审审核人" SortExpression="SecondAuditor">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
