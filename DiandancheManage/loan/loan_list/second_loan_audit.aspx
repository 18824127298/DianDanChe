<%@ Page Language="C#" AutoEventWireup="true" CodeFile="second_loan_audit.aspx.cs" Inherits="loan_loan_list_second_loan_audit" %>
                ...
                <table width="100%" cellpadding="8" cellspacing="1" align="center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>押金：<asp:Label ID="Deposit" runat="server" Style="color: red;"></asp:Label></td>
                            <td>租金：<asp:Label ID="BicyclesRent" runat="server" Style="color: red;"></asp:Label></td>
                        </tr>
                        <tr>
                ...
                <table width="100%" cellpadding="8" cellspacing="1" align="center" style="margin-top: 10px;">
                    ...
                    <tbody>
                        ...
                        <tr runat="server">
                            <td>风控审核意见：</td>
                            <td colspan="3">
                                <asp:Label ID="lblAuditOpinion" runat="server" Width="80%"></asp:Label>
                            </td>
