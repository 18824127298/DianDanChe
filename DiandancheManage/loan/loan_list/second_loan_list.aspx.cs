...
public partial class loan_loan_list_second_loan_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                       = @"select l.CreditPhone, i.Name, b.FullName,l.BusinessName, l.RecruitmentName,l.WithinMonth, l.TotalAmountStage,
         l.Deposit, l.BicyclesRent, l.Deadline, l.CustomerClassification, l.CreateTime,l.Id, l.LoanType, l.Company from LoanApply l join IdCardInformation i on l.BorrowerId= i.BorrowerId join Borrower b on b.Id = l.SalesmanId
 where l.IsValid= 1 and l.RepaymentStatus = 8 and i.IsValid= 1 and l.Company > 0";
