<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rent_borrow_list.aspx.cs" Inherits="loan_loan_list_rent_borrow_list" %>
                    ...
                    <td>
                        <asp:GridView ID="gvList" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" OnSorting="gvList_Sorting" EnableViewState="False" CellPadding="8">
                            <Columns>
                                ...
                                <asp:BoundField DataField="sumtotal" HeaderText="租金" SortExpression="sumtotal">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Principal" HeaderText="租赁费" SortExpression="Principal">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Interest" HeaderText="租金收费" SortExpression="Interest">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="OverInterest" HeaderText="逾期收费" SortExpression="OverInterest">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
