<%@ Page Language="C#" AutoEventWireup="true" CodeFile="othercompany_loan_details.aspx.cs" Inherits="loan_loan_list_othercompany_loan_details" %>
                    ...
                    <tfoot>
                        <tr align="center">
                            ...
                            <td colspan="5">&nbsp;&nbsp;<asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" OnClientClick="return confirm('确认提交吗?')" Text="提交" />
                                ...
                                &nbsp;&nbsp;<asp:Button ID="btnDownLoad" runat="server" Text=" 下载 " OnClick="btnDownLoad_Click" style="height: 21px" />
                            </td>
