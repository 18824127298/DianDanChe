...
public partial class loan_loan_list_rent_borrow_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                       = "select *, UnPrincipal+UnTotalInterest as sumuntotal, Principal+Interest as sumtotal from Borrow b join LoanApply l on b.LoanApplyId = l.Id where b.IsValid= 1 and b.LoanApplyId=" + nId;
