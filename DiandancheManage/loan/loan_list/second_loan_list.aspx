<%@ Page Language="C#" AutoEventWireup="true" CodeFile="second_loan_list.aspx.cs" Inherits="loan_loan_list_second_loan_list" %>
                    ...
                    <td>
                        <asp:GridView ID="gvList" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False" EnableViewState="False" CellPadding="8">
                            <Columns>
                                ...
                                <asp:BoundField DataField="WithinMonth" HeaderText="起租期">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="TotalAmountStage" HeaderText="委托车辆价格">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="BicyclesRent" HeaderText="租金">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
