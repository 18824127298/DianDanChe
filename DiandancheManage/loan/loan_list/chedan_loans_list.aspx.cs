...
public partial class loan_loan_list_chedan_loans_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
         ...
         l.TotalAmountStage, l.Deadline, l.CustomerClassification, l.AuditTime,l.Id, l.CancellationRemark from LoanApply l join IdCardInformation i on l.BorrowerId= i.BorrowerId join Borrower b on b.Id = l.SalesmanId
 where l.IsValid= 1 and l.RepaymentStatus = 11 and i.IsValid= 1";
