...
public partial class loan_loan_discount_other_discount_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                      = @"select l.Id, l.CreditPhone, i.Name, b.FullName,l.BusinessName, l.RecruitmentName,l.TotalAmountStage, l.BicyclesRent,
...
join Borrower b on b.Id = l.SalesmanId left join Discount d on d.LoanApplyId= l.Id 
 where l.IsValid= 1 and i.IsValid= 1 and d.IsValid= 1 and d.Amount>0 and d.SecondAuditResult = 1 and l.IsMarchantAgree = 1 and l.Company > 0 group by
l.Id, l.CreditPhone, i.Name, b.FullName,l.BusinessName, l.RecruitmentName,
l.TotalAmountStage,l.Deadline, l.CustomerClassification,d.Remark, d.CreateTime,l.BicyclesRent";
    ...
    {
        string sql = @"select l.Id, l.CreditPhone, i.Name, b.FullName,l.BusinessName, l.RecruitmentName,l.TotalAmountStage,l.BicyclesRent,
l.Deadline, l.CustomerClassification, SUM(d.Amount) as Amount, SUM(d.LeftAmount) as Leftamount,d.Remark, d.CreateTime
from LoanApply l join IdCardInformation i on l.BorrowerId= i.BorrowerId 
join Borrower b on b.Id = l.SalesmanId left join Discount d on d.LoanApplyId= l.Id
 where l.IsValid= 1 and i.IsValid= 1 and d.IsValid= 1 and d.Amount>0  and d.SecondAuditResult = 1 and l.IsMarchantAgree = 1 and l.Company > 0";
