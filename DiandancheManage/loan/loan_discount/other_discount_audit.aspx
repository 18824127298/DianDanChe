<%@ Page Language="C#" AutoEventWireup="true" CodeFile="other_discount_audit.aspx.cs" Inherits="loan_loan_discount_other_discount_audit" %>
        ...
        <div>
                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="lblTitle" runat="server" Text="减免金额审核"></asp:Label></td>
                    </tr>
                </table>
                <hr />
            </div>
            ...
            <div class="contentTable">
                ...
                <table border="0" width="600" cellpadding="8" cellspacing="1" align="center">
                    ...
                    <tfoot>
                        <tr align="center">
                            <td colspan="2" nowrap>&nbsp;<asp:Button ID="btnAudit" runat="server" Text="审核通过"  OnClientClick="return confirm('您确认进行审核操作吗?')" OnClick="btnAudit_Click" />
                                &nbsp; &nbsp;
