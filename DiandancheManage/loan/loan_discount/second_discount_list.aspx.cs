...
public partial class loan_loan_discount_second_discount_list : SbtPageBase
{
...
where d.IsValid= 1 and d.IsAudit = 1 and d.SecondAuditResult is null and l.Company = 0";
    ...
    {
        return "<a class=\"bkcYellow\"  title=\"审核\" href=\"second_discount_audit.aspx?rec_key=" + ConvertUtil.ToInt(oId) + "\"  >审核</a>";
    }
}