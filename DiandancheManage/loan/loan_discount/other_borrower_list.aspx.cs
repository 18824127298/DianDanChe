...
public partial class loan_loan_discount_other_borrower_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                      = @"select l.CreditPhone, i.Name, b.FullName,l.BusinessName, l.RecruitmentName, l.BicyclesRent,
 ...
 where l.IsValid= 1 and l.RepaymentStatus = 5 and i.IsValid= 1 and l.IsMarchantAgree = 1 and l.Company > 0";
    ...
    {
        string sql = @"select l.CreditPhone, i.Name, b.FullName,l.BusinessName, l.RecruitmentName, l.BicyclesRent,
         l.TotalAmountStage, l.Deadline, l.CustomerClassification, l.AuditTime,l.Id,l.RepaymentStatus from LoanApply l join IdCardInformation i on l.BorrowerId= i.BorrowerId join Borrower b on b.Id = l.SalesmanId
