<%@ Page Language="C#" AutoEventWireup="true" CodeFile="second_discount_audit.aspx.cs" Inherits="loan_loan_discount_second_discount_audit" %>
    ...
    <form id="form1" runat="server">
        <div>
                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="lblTitle" runat="server" Text="减免金额终审"></asp:Label></td>
                    </tr>
                </table>
                <hr />
            </div>
            ...
            <div class="contentTable">
             ...
             <%--           <tr>
                            <td nowrap>初审通过备注：</td>
                            <td>&nbsp;<asp:Label ID="lblAuditRemark" runat="server"></asp:Label></td>
                        </tr>--%>
                        <tr>
                            <td nowrap>审核备注：</td>
                            <td>&nbsp;<asp:TextBox ID="edtSecondAuditRemark" runat="server" Width="450px" SkinID="MultiLine" TextMode="MultiLine" Rows="3" />
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
