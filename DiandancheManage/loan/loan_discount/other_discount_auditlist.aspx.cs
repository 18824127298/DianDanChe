...
public partial class loan_loan_discount_other_discount_auditlist : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                       = @"select d.*, b.FullName,b.Phone from Discount d join Borrower b on d.BorrowerId = b.Id join LoanApply l 
on l.Id = d.LoanApplyId where d.IsValid= 1 and d.IsAudit is null and  l.IsMarchantAgree = 1 and l.Company > 0";
    ...
    {
        return "<a class=\"bkcYellow\"  title=\"审核\" href=\"other_discount_audit.aspx?rec_key=" + ConvertUtil.ToInt(oId) + "\"  >审核</a>";
    }
}