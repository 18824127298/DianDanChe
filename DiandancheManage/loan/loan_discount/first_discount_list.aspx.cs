...
public partial class loan_loan_discount_first_discount_list : SbtPageBase
{
...
on d.BorrowerId = b.Id where d.IsValid= 1 and d.IsAudit is null";
    ...
    {
        return "<a class=\"bkcYellow\"  title=\"审核\" href=\"first_discount_audit.aspx?rec_key=" + ConvertUtil.ToInt(oId) + "\"  >审核</a>";
    }
}