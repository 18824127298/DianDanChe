<%@ Page Language="C#" AutoEventWireup="true" CodeFile="oilgun_update.aspx.cs" Inherits="youka_oilgun_oilgun_update" %>

<%@ Register Src="../../module/My97DatePicker.ascx" TagName="DatePicker" TagPrefix="uc1" %>
<html>
<head id="Head1" runat="server">
    <title>加油站商品信息编辑</title>
</head>
<body>
                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="lblTitle" runat="server" Text="加油站商品信息编辑"></asp:Label>
                        </td>
                    </tr>
                </table>
                <hr />
            ...
            <div class="contentTable">
                ...
                <table border="0" width="650" cellpadding="6" cellspacing="1" align="center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>枪号：</td>
                            <td>&nbsp;<asp:Label ID="GunNumber" runat="server" Text="Label"></asp:Label></td>
                        </tr>
                        <tr>
                            <td>老优惠：</td>
                    ...
                    <%--    <tr>
                        ...
                        <tr>
                            <td>国标价时间点：</td>
                            <td>&nbsp;<uc1:DatePicker ID="CountryPointTime" runat="server" ShowDateFmt="yyyy-MM-dd HH:mm:ss" />
                            </td>
                        </tr>--%>
                    </tbody>
                    <tfoot>
