<%@ Page Language="C#" AutoEventWireup="true" CodeFile="supplier_insert.aspx.cs" Inherits="youka_supplier_supplier_insert" %>
                ...
                <table border="0" cellpadding="3" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="lblTitle" runat="server" Text="新增物流公司"></asp:Label>
                        </td>
                    </tr>
                </table>
                <hr />
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3" align="center">
                                <asp:Button ID="btnOK" runat="server" Text="新增" OnClientClick="return confirm('您确认新增物流公司吗?')"
                                    OnClick="btnOK_Click" />
                                &nbsp;&nbsp;
