<%@ Page Language="C#" AutoEventWireup="true" CodeFile="supplier_recharge.aspx.cs" Inherits="youka_supplier_supplier_recharge" %>
            ...
            <div class="contentTable">
                <table border="1" width="800" cellpadding="8" cellspacing="1" align="center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="right">充值的时间：</td>
                            <td style="padding-left: 27px">
                                <uc1:DatePicker ID="RechargeTime" runat="server" ShowDateFmt="yyyy-MM-dd HH:mm:ss" />
                            </td>
                        </tr>
                        <tr>
                            <td align="right">备注：
