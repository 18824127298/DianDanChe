...
public partial class youka_member_member_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                       = @"select * from Member where IsValid = 1";
    ...
    {
        string sql = @"select * from Member where IsValid = 1 ";
    ...
    {
        Response.Redirect("../borrower_list/borrower_insert.aspx");
    }
}