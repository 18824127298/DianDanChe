...
public partial class caiwu_caiwu_zhidan_caiwu_zhidan_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                       = @"select r.Id, b.Phone, b.FullName, r.Amount, r.RechargeTime from Recharge r join Borrower b on r.BorrowerId = b.Id
 where r.IsValid = 1 and r.IsAudit is null and r.RechargeMode=" + (int)RechargeMode.后台充值;
    ...
    {
        return "<a class=\"bkcYellow\"  title=\"审核充值\" href=\"zhidan_audit.aspx?rec_key=" + ConvertUtil.ToInt(oId) + "\"  >审核充值</a>";
    }
