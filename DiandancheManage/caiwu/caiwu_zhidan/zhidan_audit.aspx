<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zhidan_audit.aspx.cs" Inherits="caiwu_caiwu_zhidan_zhidan_audit" %>
            ...
            <div class="contentTable">
                ...
                <table border="0" width="600" cellpadding="8" cellspacing="1" align="center">
                    <tbody>
                        ...
                        <tr>
                            <td nowrap>提单备注：</td>
                            <td>&nbsp;<asp:Label ID="lblRechargeRemark" runat="server"></asp:Label></td>
                        </tr>
                        <tr>
                            <td nowrap>审核备注：</td>
