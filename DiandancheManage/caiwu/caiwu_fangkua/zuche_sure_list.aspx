<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zuche_sure_list.aspx.cs" Inherits="caiwu_caiwu_fangkua_zuche_sure_list" %>
                    ...
                    <td>
                        <asp:GridView ID="gvList" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" OnSorting="gvList_Sorting" EnableViewState="False" CellPadding="8">
                            <Columns>
                                ...
                                <asp:BoundField DataField="SecondAuditor" HeaderText="审核人" SortExpression="SecondAuditor">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SecondAuditTime" HeaderText="审核时间" SortExpression="SecondAuditTime">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
...
<script type="text/javascript">
    ...
    {
        location.href = "zuche_fangkuang.aspx?rec_key="+Id;
    }
</script>
