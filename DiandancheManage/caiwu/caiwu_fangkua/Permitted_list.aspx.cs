...
public partial class caiwu_caiwu_fangkua_Permitted_list : SbtPageBase
{
...
l.TotalAmountStage, l.Deadline, l.CustomerClassification, l.AuditTime,l.Id, l.LendingDate, l.RepaymentStatus, l.MentionBackTime from LoanApply l join IdCardInformation i on l.BorrowerId= i.BorrowerId join Borrower b on b.Id = l.SalesmanId
 where l.IsValid= 1 and (l.RepaymentStatus = 5 or l.RepaymentStatus = 6) and i.IsValid= 1 and l.IsMentionBack = 1";
    ...
    {
        return ((CreditStatus)ConvertUtil.ToInt(oRepaymentStatus)).ToString();
    }
