<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Permitted_list.aspx.cs" Inherits="caiwu_caiwu_fangkua_Permitted_list" %>
                        ...
                        <asp:GridView ID="gvList" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False" AllowSorting="True" OnSorting="gvList_Sorting" EnableViewState="False" CellPadding="8">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Auditor" HeaderText="审核人" SortExpression="Auditor">
                                  ...
                                  <asp:TemplateField HeaderText="状态" SortExpression="RepaymentStatus">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <%# VIVRepaymentStatus(Eval("RepaymentStatus")) %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="MentionBackTime" HeaderText="允许提还时间" SortExpression="MentionBackTime">
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                            </Columns>
