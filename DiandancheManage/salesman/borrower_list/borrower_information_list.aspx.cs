...
public partial class salesman_borrower_list_borrower_information_list : SbtPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            CurrentPageStatus.DataViewStatus.SqlBuilder.NonConditionSql
                       = @"select * from BusinessFile where IsValid = 1 and (Sort = 2 or Sort = 1) and BusinessType=" + (int)BusinessType.客户的信息照 + " and RelationId=" + nId;
