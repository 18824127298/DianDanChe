...
namespace Sigbit.Data
{
    ...
    /// 
    /// </summary>
    public class DBConnPostgreSql:DBConnBase
    {
        

        private NpgsqlConnection _sqlConn = null;
        ...
        override public void Connect()
        {
            ...
            _sqlConn = new NpgsqlConnection(ConnectString);
            _sqlConn.Open();
        }
        ...
        override public int ExecuteNonQuery(string sSQL)
        {
            lock (this)
            {
                //============= 1. 创建Command ==========
                NpgsqlCommand cmd;
                cmd = new NpgsqlCommand(sSQL, _sqlConn);
        ...
        override public DataSet ExecuteDataSet(string sSQL)
        {
            ...
            lock (this)
            {
                ...
                cmd = new NpgsqlCommand(sLimitSQL, _sqlConn);
