...
function check_reg_rec()
{
        ...
        tmp.AsseblyName = "Sigbit.App.Net.IBXService.VoiceReg.Service.dll";
        tmp.TypeName = "Sigbit.App.Net.IBXService.VoiceReg.Service.CheckNewRequest__ForJS.CheckNewRequest__ForJS";
