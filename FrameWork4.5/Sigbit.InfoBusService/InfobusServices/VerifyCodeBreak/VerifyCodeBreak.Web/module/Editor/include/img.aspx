							...
							<table border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								<tr>
									...
									<td width="40" align="right">
                                        <span style="color: gray">网络:</span></td>
									<td width="5"></td>
									<td width="*"><input type="text" id="d_fromurl" style="WIDTH:140px" size="30" value="http://" onkeyup="showimages()" maxlength="1000" disabled="disabled">
                                        <input type="submit" value='确定' id="Ok" onclick="ok()" style="width: 30px" contenteditable="" disabled="disabled">&nbsp;<input type="button" value='取消' onclick="window.close();" style="width: 30px" disabled="disabled"></td>
									<td width="7"></td>
								</tr>
								<tr>
									<td width="2"></td>
									<td width="40" align="right">本地:</td>
									<td width="5"></td>
								...
								<tr>
									<td colspan="5" height="5"><FONT face="宋体"></FONT></td>
								</tr>
							</table>
						</fieldset>
						<BR>
