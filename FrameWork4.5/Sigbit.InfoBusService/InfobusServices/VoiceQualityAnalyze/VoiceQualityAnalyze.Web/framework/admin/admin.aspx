<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin.aspx.cs" Inherits="framework_admin_Login" %>
                        ...
                        <table id="Table1" height="412" cellspacing="0" cellpadding="0" width="399" align="center"
                            ...
                            <tr>
                                <td valign="middle" align="right" background="images/admin.jpg" runat="server" id="tdMainInput">
                                    ...
                                    <br>
                                    <br>
                                    <table class="small" id="Table2" style="margin-top: 10px; margin-left: 5px" cellspacing="8"
