            ...
            <table border="0" cellpadding="3" cellspacing="0" width="100%">
                <tr>
                    <td>
                        ...
                        <asp:Label ID="lblTitle" runat="server" Text="用户属性"></asp:Label></td>
                </tr>
            </table>
            <hr />
        </div>
        ...
        <tbody>
            ...
            <tr>
                <td nowrap>
                    姓名：</td>
                <td>
                    &nbsp;<asp:TextBox ID="edtRealName" runat="server" Width="200px"></asp:TextBox></td>
            </tr>
            <tr>
                <td nowrap>
                    密码：</td>
                <td>
                    &nbsp;<asp:TextBox ID="edtPassword" runat="server" Width="200px">***** ***** ***** *****</asp:TextBox></td>
            </tr>
            <tr>
                <td nowrap="nowrap">
                    部门：</td>
                <td>
                    &nbsp;<asp:DropDownList ID="ddlbDeptId" runat="server" Width="200px">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td nowrap>
                    联系电话：</td>
                <td>
                    &nbsp;<asp:TextBox ID="edtTelephone" runat="server" Width="200px"></asp:TextBox></td>
            </tr>
            <tr>
                <td nowrap>
                    性别：</td>
            ...
            <tr>
                ...
                <td>
                    &nbsp;<asp:CheckBox ID="cbxIsAdmin" runat="server" Text="超级管理员" /></td>
            </tr>
            <tr>
                <td nowrap>
                    备注：</td>
                <td>
                    &nbsp;<asp:TextBox ID="edtRemarks" runat="server" Width="300px" Height="50px" SkinID="multiLine" TextMode="MultiLine"></asp:TextBox></td>
            </tr>
        </tbody>
        <tfoot>
            <tr align="center">
