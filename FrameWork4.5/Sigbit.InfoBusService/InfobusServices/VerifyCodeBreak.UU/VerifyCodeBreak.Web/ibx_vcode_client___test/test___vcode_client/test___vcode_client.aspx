<%@ Page Language="C#" AutoEventWireup="true" CodeFile="test___vcode_client.aspx.cs" Inherits="ibx_vcode_client___test_test___vcode_client_test___vcode_client" %>
    ...
    <div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    &nbsp;<asp:CheckBox ID="cbxSyncCall" runat="server" Checked="True" Text="同步调用" /></td>
            </tr>
            <tr>
                <td nowrap>
                    破解结果：</td>
        ...
        <tfoot>
            <tr align="center">
                <td colspan="2" nowrap>
                    &nbsp;<asp:Button ID="btnUploadImage" runat="server" Text="上传图片得到回执" 
                        onclick="btnUploadImage_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button
                            ID="btnUploadAndBreak" runat="server" Text="根据回执发送请求，得到破解结果" 
